...
class Tin {
    ...
    setCompiled(compiled) {
        ...
        if (!compiled.tins && compiled.points && compiled.tins_points) {
            ...
            const points = [];
            for (let i = 0; i < ((_a = this.tins) === null || _a === void 0 ? void 0 : _a.forw.features.length); i++) {
                const tri = (_b = this.tins) === null || _b === void 0 ? void 0 : _b.forw.features[i];
                ["a", "b", "c"].map((key, idx) => {
                    var _a;
                    const forw = (_a = tri === null || tri === void 0 ? void 0 : tri.geometry) === null || _a === void 0 ? void 0 : _a.coordinates[0][idx];
                    const bakw = (tri === null || tri === void 0 ? void 0 : tri.properties)[key].geom;
                    const pIdx = (tri === null || tri === void 0 ? void 0 : tri.properties)[key].index;
    ...
    getCompiled() {
        ...
        compiled.centroid_point = [
            (_b = (_a = this.centroid) === null || _a === void 0 ? void 0 : _a.forw.geometry) === null || _b === void 0 ? void 0 : _b.coordinates,
            (_d = (_c = this.centroid) === null || _c === void 0 ? void 0 : _c.forw.properties) === null || _d === void 0 ? void 0 : _d.target.geom
        ];
        ...
        (_e = this.tins) === null || _e === void 0 ? void 0 : _e.forw.features.map((tin) => {
        ...
        if (this.strict_status == Tin.STATUS_LOOSE) {
            ...
            (_g = (_f = this.tins) === null || _f === void 0 ? void 0 : _f.bakw) === null || _g === void 0 ? void 0 : _g.features.map((tin) => {
    ...
    addIndexedTin() {
        ...
        const forw = tins === null || tins === void 0 ? void 0 : tins.forw;
        const bakw = tins === null || tins === void 0 ? void 0 : tins.bakw;
        const gridNum = Math.ceil(Math.sqrt(forw === null || forw === void 0 ? void 0 : forw.features.length));
        if (gridNum < 3) {
            this.indexedTins = undefined;
            return;
        }
        let forwBound = null;
        let bakwBound = null;
        const forwEachBound = forw === null || forw === void 0 ? void 0 : forw.features.map((tri) => {
            let eachBound = null;
        ...
        const forwGridCache = forwEachBound === null || forwEachBound === void 0 ? void 0 : forwEachBound.reduce((prev, bound, index) => {
        ...
        const bakwEachBound = bakw === null || bakw === void 0 ? void 0 : bakw.features.map((tri) => {
            let eachBound = null;
            getCoords(tri)[0].map((point) => {
                if (bakwBound == null)
        ...
        const bakwGridCache = bakwEachBound === null || bakwEachBound === void 0 ? void 0 : bakwEachBound.reduce((prev, bound, index) => {
    ...
    calcurateStrictTinAsync() {
        ...
        return Promise.all(this.tins.forw.features.map((tri) => Promise.resolve(counterTri(tri))))
            ...
            return Promise.all(this.tins.forw.features.map((forTri, index) => {
                var _a, _b;
                const bakTri = (_b = (_a = this.tins) === null || _a === void 0 ? void 0 : _a.bakw) === null || _b === void 0 ? void 0 : _b.features[index];
            ...
            return Promise.all(["forw", "bakw"].map((direc) => new Promise(resolve => {
                const coords = this.tins[direc].features.map((poly) => { var _a; return (_a = poly.geometry) === null || _a === void 0 ? void 0 : _a.coordinates[0]; });
    ...
    updateTinAsync() {
        ...
        return new Promise(resolve => {
            ...
            if (tinForCentroid.features.length == 0 ||
                ...
                throw "TOO LINEAR1";
            const forwCoord = (_a = forCentroidFt.geometry) === null || _a === void 0 ? void 0 : _a.coordinates;
            ...
            return prom
                ...
                this.vertices_params = {
                    forw: vertexCalc(verticesList.forw, (_a = this.centroid) === null || _a === void 0 ? void 0 : _a.forw),
                    bakw: vertexCalc(verticesList.bakw, (_b = this.centroid) === null || _b === void 0 ? void 0 : _b.bakw)
                };
                this.addIndexedTin();
    ...
    transform(apoint, backward, ignoreBounds) {
        ...
        const tins = backward ? (_a = this.tins) === null || _a === void 0 ? void 0 : _a.bakw : (_b = this.tins) === null || _b === void 0 ? void 0 : _b.forw;
        ...
        const centroid = backward ? (_c = this.centroid) === null || _c === void 0 ? void 0 : _c.bakw : (_d = this.centroid) === null || _d === void 0 ? void 0 : _d.forw;
                ...
                return new Promise(resolve => {
                    ...
                    for (let i = 0; i < 3; i++) {
                        ...
                        if (!alreadyChecked[key]) {
                            const fromi = (_a = tri.geometry) === null || _a === void 0 ? void 0 : _a.coordinates[0][i];
                            const fromj = (_b = tri.geometry) === null || _b === void 0 ? void 0 : _b.coordinates[0][j];
...
function counterPoint(apoint) {
    var _a, _b, _c;
    return point((_a = apoint.properties) === null || _a === void 0 ? void 0 : _a.target.geom, {
        target: {
            geom: (_b = apoint.geometry) === null || _b === void 0 ? void 0 : _b.coordinates,
            index: (_c = apoint.properties) === null || _c === void 0 ? void 0 : _c.target.index
        }
    });
}
...
function transform(point_a, tins, indexedTins = undefined, verticesParams = undefined, centroid = undefined, weightBuffer = undefined, stateTriangle, stateSetFunc) {
    return point(transformArr(point_a, tins, indexedTins, verticesParams, centroid, weightBuffer, stateTriangle, stateSetFunc));
}
function transformArr(point, tins, indexedTins = undefined, verticesParams = undefined, centroid = undefined, weightBuffer = undefined, stateTriangle, stateSetFunc) {
    var _a;
    let tin;
    if (stateTriangle) {
    ...
    if (!tin) {
        if (indexedTins) {
            const coords = (_a = point.geometry) === null || _a === void 0 ? void 0 : _a.coordinates;
